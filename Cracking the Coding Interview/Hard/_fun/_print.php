...
$arrQuest = array("1. Write a function that adds two numbers. You should not use + or any arithmetic operators.",
...
"10. Imagine you have a square matrix, where each cell is filled with either black or white. Design an algorithm to find the maximum subsquare such that all four borders are filled with black pixels.",
"11. Given an NxN matrix of positive and negative integers, write code to find the submatrix with the largest possible sum.");


function echoPrint($string) {
    echo "<br><p>".$string."</p>";
}
